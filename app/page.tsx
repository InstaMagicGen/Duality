...
export default function Page() {
  ...
  return (
    <main
      dir={lang === 'ar' ? 'rtl' : 'ltr'}
      className="min-h-screen flex flex-col items-center justify-start px-6 py-6 bg-background text-foreground transition-colors duration-300"
    >
      {/* Header */}
        ...
        {theme === 'light' ? (
          <div className="flex gap-6">
            <div className="flex flex-col gap-6">
              {/* Duality & Soulset cards on left in light mode */}
              <div className="app-card light-mode">
                <h2 className="text-2xl font-bold mb-2">{t.duality.title}</h2>
                <p className="text-black mb-4">{t.duality.description}</p>
              ...
              <div className="app-card light-mode">
                ...
                <p className="text-black mb-4">{t.soulset.description}</p>
